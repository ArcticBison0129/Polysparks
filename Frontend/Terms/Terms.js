...
const lastSection = document.querySelector('#contact'); // Section 14 - Contact Us
...
function updateTOCHighlight() {
    ...
    // Handle TOC sliding up when reaching end of section 14
    if (toc && lastSection) {
        ...
        // If user has scrolled past the bottom of section 14, slide up the TOC
